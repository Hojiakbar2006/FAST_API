...
from database import User, Order, SessionLocal
from model_schema import OrderModel, OrderStatusModel
...
async def place_an_order(order: OrderModel, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
    ## Placing an Order
...
async def list_all_orders(db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
    ## List all orders
...
async def get_order_by_id(id: int, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
...
async def get_user_orders(db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
...
async def get_specific_order(id: int, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
...
async def update_order(id: int, order: OrderModel, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
    ## Updating an order
...
async def update_order_status(id: int, order: OrderStatusModel, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
...
async def delete_an_order(id: int, db: Session = Depends(get_db), Authorize: AuthJWT = Depends()):
    """
    ## Delete an Order
